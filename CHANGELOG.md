...
- updated pypi-publish to create release

## Bugfixes

- incorrect version replace in rfc2html.py
- allow release update during deploy
- build vars incorrect on publish
- update changelog
...
## [2.0.2(https://github.com/ietf-tools/rfc2html/compare/v2.0.1...v2.0.2)]
